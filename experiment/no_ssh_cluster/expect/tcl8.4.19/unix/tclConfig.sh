...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/no_ssh_cluster/expect/tcl8.4.19/unix -ltcl8.4${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/root/no_ssh_cluster/expect/tcl8.4.19'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/no_ssh_cluster/expect/tcl8.4.19/unix -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/root/no_ssh_cluster/expect/tcl8.4.19/unix/libtclstub8.4${TCL_DBGX}.a'
