...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/deploy-work/no_ssh/expect/tcl8.4.19/unix -ltcl8.4${TCL_DBGX}'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/deploy-work/no_ssh/expect/tcl8.4.19/unix -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/root/deploy-work/no_ssh/expect/tcl8.4.19/unix/libtclstub8.4${TCL_DBGX}.a'
